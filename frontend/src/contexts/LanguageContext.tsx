...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'experience.1.company': 'WhaleDog',
    'experience.1.period': '2026',
    'experience.1.description': 'Full stack development for Edgar Ruiz #54 Liberal Party senate campaign. Handled deployment, design, DevOps, frontend and backend for https://edgarruiz.vote/',
    'experience.2.title': 'Junior Programmer',
    'experience.2.company': 'Freelancer',
    'experience.2.period': '2025',
    'experience.2.description': 'Developed a Linux simulation with Geolandspill for crude oil spill modeling for an oil company.',
    'experience.3.title': 'Assistant Teacher',
    'experience.3.company': 'Fundación Nuevo Amanecer ESAL Chocó and Universidad EAN',
    'experience.3.period': '2025',
    'experience.3.description': 'Taught classes in the STEMChocó project, achieving the construction of a CANSAT with low-income girls.',
    'experience.4.title': 'University Tutor - Circuits',
    'experience.4.company': 'Universidad EAN',
    'experience.4.period': '2025',
    'experience.4.description': 'Provided tutoring and collaborated in directing class laboratories for the Circuits subject.',
    'experience.5.title': 'University Tutor - Electronics',
    'experience.5.company': 'Universidad EAN',
    'experience.5.period': '2025',
    'experience.5.description': 'Provided tutoring and collaborated in directing class laboratories for the Electronics subject.',
  ...
  es: {
    ...
    'experience.1.company': 'WhaleDog',
    'experience.1.period': '2026',
    'experience.1.description': 'Desarrollo full stack para la campaña al senado de Edgar Ruiz #54 del partido liberal. Encargado del despliegue, diseño, DevOps, frontend y backend para https://edgarruiz.vote/',
    'experience.2.title': 'Programador Junior',
    'experience.2.company': 'Freelancer',
    'experience.2.period': '2025',
    'experience.2.description': 'Desarrollé una simulación en Linux con Geolandspill sobre el derrame de crudo para una petrolera.',
    'experience.3.title': 'Profesor Asistente',
    'experience.3.company': 'Fundación Nuevo Amanecer ESAL Chocó y Universidad EAN',
    'experience.3.period': '2025',
    'experience.3.description': 'Impartí clases en el proyecto STEMChocó, con las cuales logramos realizar un CANSAT con niñas de bajos recursos.',
    'experience.4.title': 'Monitor Universitario - Circuitos',
    'experience.4.company': 'Universidad EAN',
    'experience.4.period': '2025',
    'experience.4.description': 'Impartí monitorías y colaboré en la dirección de laboratorios de clase para la materia de Circuitos.',
    'experience.5.title': 'Monitor Universitario - Electrónica',
    'experience.5.company': 'Universidad EAN',
    'experience.5.period': '2025',
    'experience.5.description': 'Impartí monitorías y colaboré en la dirección de laboratorios de clase para la materia de Electrónica.',
