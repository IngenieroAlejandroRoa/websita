...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'experience.1.description': 'Full stack web development for a senate candidate website. Handled deployment, design, DevOps, frontend and backend development.',
  ...
  es: {
    ...
    'experience.1.company': 'WhaleDog',
    'experience.1.period': '2026',
    'experience.1.description': 'Desarrollo full stack para la página web de un candidato al senado de Colombia. Encargado del despliegue, diseño, DevOps, frontend y backend.',
